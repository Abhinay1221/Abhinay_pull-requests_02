...
1. Click the **Add a suggestion** button to insert a modifiable copy of the line.
   ...
   <img width="300" alt="add-a-suggestion-button" src="https://github.com/Abhinay1221/Abhinay_pull-requests_02/blob/main/.github/images/add-a-suggestion-button.png?raw=true" />
